    ...
    <>
      ...
      >
        <motion.input
          ...
          className="w-full placeholder:text-white p-2 rounded-md shadow-lg text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 custom-bg"
        />
        {errors.name && (
        ...
        <motion.input
          ...
          className="w-full p-2 placeholder:text-white rounded-md shadow-lg text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 custom-bg"
        />
        {errors.email && (
          <span className="inline-block self-start text-accent">
